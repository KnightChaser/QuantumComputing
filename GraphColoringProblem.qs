namespace GraphColoringProblem {
    ...
    // If the adjacent nodes share the same color
    ...
    // Validation
    //  - Repeat for all edges in the given graph
    //  - Check if the pair edges share different colors
    //   - If every pair complies the given condition, the graph coloring can be considered as valid.
    ...
    operation ShowColorEqualityCheck() : Unit {
        ...
        //  |  X  |
        // [2] - [3] - [4]
        // In adjacent nodes that connected with lines shouldn't have the same color.
...
// PS D:\HelloQ#\ExploringGroversSearch> dotnet run
